@editor @editor_atto @atto @atto_figure @_file_upload
Feature: Add figures to Atto
  To write rich text - I need to add figures.

  @javascript
  Scenario: Insert an figure
    ...
    And I set the field "Describe this figure for someone who cannot see it" to "It's the Moodle"
    ...
    And I click on "Save figure" "button"
    And I click on "Update profile" "button"
    And I follow "Edit profile"
    And I select the text in the "Description" Atto editor
    And I click on "Image" "button"
    Then the field "Describe this figure for someone who cannot see it" matches value "It's the Moodle"
    And the field "Width" matches value "123"
    And the field "Height" matches value "456"

  @javascript
  Scenario: Manually inserting an figure
    Given I log in as "admin"
    And I follow "Profile" in the user menu
    And I follow "Edit profile"
    ...
    And I set the field "Describe this figure for someone who cannot see it" to "Something"
    And I set the field "Enter URL" to ""
    And I press "Save figure"
    ...
    And the field "Width" matches value "123"
    And the field "Height" matches value "456"
    And the field "Describe this figure" matches value "Awesome!"
