YUI.add('moodle-atto_figure-button', function (Y, NAME) {
...
/**
 * @module moodle-atto_figure_alignment-button
 */

/**
 * Atto image selection tool.
 *
 * @namespace M.atto_figure
 * @class Button
 * @extends M.editor_atto.EditorPlugin
 */

var CSS = {
        RESPONSIVE: 'figure-img img-fluid',
        INPUTALIGNMENT: 'atto_figure_alignment',
        INPUTALT: 'atto_figure_altentry',
        INPUTHEIGHT: 'atto_figure_heightentry',
        INPUTSUBMIT: 'atto_figure_urlentrysubmit',
        INPUTURL: 'atto_figure_urlentry',
        INPUTSIZE: 'atto_figure_size',
        INPUTWIDTH: 'atto_figure_widthentry',
        IMAGEALTWARNING: 'atto_figure_altwarning',
        IMAGEBROWSER: 'openimagebrowser',
        IMAGEPRESENTATION: 'atto_figure_presentation',
        INPUTCONSTRAIN: 'atto_figure_constrain',
        INPUTCUSTOMSTYLE: 'atto_figure_customstyle',
        IMAGEPREVIEW: 'atto_figure_preview',
        IMAGEPREVIEWBOX: 'atto_figure_preview_box'
    },
    SELECTORS = {
